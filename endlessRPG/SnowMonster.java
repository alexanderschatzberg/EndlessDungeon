...
public class SnowMonster extends Mob {
	...
	SnowMonster(int monsterX, int delay, int destinationX, int HEIGHT, int monsterHomeX, int targetLevel,
			boolean possibleBoss, int playerLevel) {
	...
	public boolean attack1() {
		...
		if (attackStep == 1) {
			...
			// If the motion is almost complete, initialize the projectile and go to next
			// step
